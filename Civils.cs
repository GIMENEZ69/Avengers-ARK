...
namespace Avergers
{
    public partial class Civils : Form
    {
        ...
        {
            // TODO: cette ligne de code charge les données dans la table 'projetHeroDataSet3CivilGridview.Civil'. Vous pouvez la déplacer ou la supprimer selon les besoins.
            this.civilTableAdapter1.Fill(this.projetHeroDataSet3CivilGridview.Civil);
